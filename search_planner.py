...
from common import ensure_dir, get_env_value, load_env_values, normalize_whitespace, write_json
...
def build_search_plan(
    *,
    ...
    from local_pipelines.vendor.pdf_extraction.extractor import extract_pdf
