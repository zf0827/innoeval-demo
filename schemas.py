...
TASK_PAPER_GROUNDING_COMPARE = "paper_grounding_compare"
TASK_TOPIC_TREND_REVIEW = "topic_trend_review"
TASK_RELATED_AUTHORS = "related_authors"
TASK_AUTHOR_RESEARCH_PROFILE = "author_research_profile"
...
DEFAULT_TASK_PARAMS: dict[str, dict[str, Any]] = {
    ...
    TASK_RELATED_AUTHORS: {
        ...
        "search_fallback_for_query": True,
    },
    TASK_AUTHOR_RESEARCH_PROFILE: {
